export default {
    accounts: {
      ...
      platform: '平台',
      platformChangedNotice: '已选择新平台/类型，保存时将原地切换',
      platformChangeNoticeTitle: '原地切换平台与接入类型',
      platformChangeNoticeDesc: '当前账号将直接切换为新平台身份，保留原有账号 ID、名称与通用调度配置（代理、并发、优先级等）。保存后，旧厂商的凭据与探测/限流等运行态将被安全清除，请配置新平台所需凭据：',
      confirmPlatformChange: '确认切换平台并保存',
      platformChangeSuccess: '账号平台已成功原地切换',
      tokenOrKey: 'API Key / 访问凭据',
      newPlatformApiKeyHint: '新厂商的访问密钥，切换后将替代原有凭据。',
      advancedCredentialsJson: '高级凭据 JSON（可选）',
      advancedCredentialsJsonHint: '填写后将合并并优先使用此 JSON',
      invalidCredentialsJson: '高级凭据必须是 JSON 对象格式',
      invalidCredentialsJsonFormat: '高级凭据 JSON 解析失败：',
      credentialsRequired: '请提供新平台的凭据信息',
      shadowPlatformImmutable: '影子账号不支持修改厂商，请修改主账号',
      accountName: '账号名称',
