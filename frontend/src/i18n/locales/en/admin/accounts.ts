export default {
    accounts: {
      ...
      platform: 'Platform',
      platformChangedNotice: 'New platform/type selected; will switch in place upon saving',
      platformChangeNoticeTitle: 'In-place Platform & Type Change',
      platformChangeNoticeDesc: 'This account will switch to the new platform identity in place, preserving its ID, name, and scheduling settings (proxy, concurrency, priority, etc.). Previous provider secrets and runtime limits will be safely cleared. Please supply credentials for the new platform below:',
      confirmPlatformChange: 'Confirm Platform Switch & Save',
      platformChangeSuccess: 'Account platform switched successfully in place',
      tokenOrKey: 'API Key / Access Credential',
      newPlatformApiKeyHint: 'Access key for the new provider, which will replace previous credentials upon switching.',
      advancedCredentialsJson: 'Advanced Credentials JSON (Optional)',
      advancedCredentialsJsonHint: 'When supplied, this JSON object overrides standard credential inputs',
      invalidCredentialsJson: 'Advanced credentials must be a valid JSON object',
      invalidCredentialsJsonFormat: 'Failed to parse advanced credentials JSON: ',
      credentialsRequired: 'Please provide valid credentials for the new platform',
      shadowPlatformImmutable: 'Spark shadow accounts cannot change platform; please change the parent account instead',
